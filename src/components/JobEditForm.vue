...
export default {
  ...
  setup() {
    ...
    try {
      ...
      model.value.kaa.knowledge = job.kaa.knowledge.content;
      model.value.kaa.ability = job.kaa.ability.content;
      model.value.kaa.attitude = job.kaa.attitude.content;
    ...
    const saveChanges = async () => {
      try {
        ...
        const updatedModel = { 
          ...
          kaa: {
            knowledge: {
              content: model.value.kaa.knowledge
            },
            ability: {
              content: model.value.kaa.ability
            },
            attitude: {
              content: model.value.kaa.attitude
            }
          },
